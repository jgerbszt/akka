...
:ref:`disabled Java serializer <disable-java-serializer-scala>`. Additional protection when running in an 
untrusted network is achieved by enabling :ref:`TLS with mutual authentication <remote-tls-scala>`.
...
We would like to thank Munoz, Alvaro & Adrian Bravo for their thorough investigation and bringing this issue to our attention.